...
import LicensesAndCertificationsCard from './LicensesAndCertificationsCard';
  ...
  const buildCertifications = (tFn) => [
    {
      ...
      issuer: 'Coursera',
      issueDate: tFn('LicensesAndCertifications.credentialsList.c1.issueDate'),
    ...
    },
    {
      ...
      issueDate: tFn('LicensesAndCertifications.credentialsList.c2.issueDate'),
    ...
    },
    {
      ...
      issueDate: tFn('LicensesAndCertifications.credentialsList.c3.issueDate'),
